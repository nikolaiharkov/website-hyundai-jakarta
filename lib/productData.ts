export const DETAILED_PRODUCT_INFO: Record<string, any> = {
  ...
  "all-new-santa-fe": {
    ...
    specs: {
      "Penggerak": "Hybrid / Bensin 2.5L",
      "Fitur": "Hyundai SmartSense Lengkap",
  ...
  "palisade": {
    ...
    variants: [
      { name: "Prime", price: "Rp 943.800.000" },
      { name: "Signature 2WD", price: "Rp 1.105.000.000" },
      { name: "Signature AWD", price: "Rp 1.359.000.000" }
    ],
    features: ["Triple Zone Full Auto AC", "Dual Sunroof", "Infinity Premium Audio", "Heated & Ventilated Seats"],
    specs: {
      "Mesin": "R 2.2 CRDi Diesel Turbo",
      "Tenaga": "200 PS / 3,800 rpm",
      "Torsi": "441 Nm / 1,750 - 2,750 rpm",
  ...
  "ioniq-5": {
    ...
    specs: {
      "Baterai": "58 kWh - 72.6 kWh",
      "Jarak Tempuh": "Hingga 481 km (WLTP)",
  ...
  "ioniq-6": {
    ...
    specs: {
      "Baterai": "77.4 kWh",
      "Jarak Tempuh": "519 km (WLTP)",
      "Charging (AC 11kW)": "0-100% dalam 7 Jam 20 Menit",
  ...
  "all-new-kona-electric": {
    ...
    specs: {
      "Baterai": "66 kWh (Long Range)",
      "Jarak Tempuh": "Hingga 602 km (NEDC)",
  ...
  "staria": {
    ...
    variants: [
      { name: "Signature 9", price: "Rp 934.700.000" },
      { name: "Signature 7", price: "Rp 1.072.000.000" }
    ],
    features: ["Premium Relaxation Seats", "Smart Power Sliding Door", "Full Digital Cluster", "BOSE Premium Sound"],
    specs: {
      "Mesin": "2.2 Diesel Turbo",
      "Tenaga": "177 PS",
      "Torsi": "430 Nm",
      "Kapasitas": "7 atau 9 Penumpang"
    }
  }
};
