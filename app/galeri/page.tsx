...
export default function GaleriPage() {
  ...
  const items = [
    { id: 1, type: "delivery", title: "Delivery Stargazer", img: "/foto-product/2130555e48_hyundai-stargazer-prime-creamy-white-pearl__1_-removebg-preview-5.png" }, // Placeholder img
    ...
    <div className="bg-hyundai-light min-h-screen pb-20">
      <section className="relative pt-32 pb-20 bg-hyundai-primary text-center text-white">
        <div className="absolute inset-0 z-0">
          <img src="/assets/backgroud/hyundai-simprug.jpeg" alt="Galeri" className="w-full h-full object-cover opacity-50" />
